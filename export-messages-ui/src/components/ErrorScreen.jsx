        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            {isTokenExpired
              ...
              : isInstallRequired
                ? 'Export Messages is not installed in this sub-account. Please install the app first.'
                : errorString
            }
          </p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-6">
                ...
                <ol className="list-decimal list-inside space-y-3 text-sm text-purple-900">
                  <li className="font-medium">
                    <strong>{isTokenExpired ? 'Reconnect' : 'Install'} Export Messages via OAuth:</strong>
                    <br />
                    <a 
                  ...
                  <li>Find "Export Messages" in your sub-account's left sidebar to access</li>
                </ol>
              </div>
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4 text-sm">
                ...
                <p className="text-yellow-800">
                  {isTokenExpired 
                    ...
                    : 'This app must be installed via OAuth before it can be used. After installation, it will appear as "Export Messages" in your sub-account navigation menu.'
                  }
                </p>
              </div>
            </div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            {needsReconnect && (
              ...
              >
                {isTokenExpired ? '🔄 Reconnect App' : '📦 Install Export Messages'}
              </a>
            )}
          </div>
        </div>
