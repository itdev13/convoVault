        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              ...
              <p className="text-xs text-white/70 mt-1">{`Pay-per-use at $${UNIT_PRICES.socialPosts}/post with bulk savings`}</p>
            </div>
          </div>
            ...
            <Tooltip
              title={
                <div style={{ fontSize: '13px', lineHeight: '1.6' }}>
                  ...
                  <br />
                  ${`$${UNIT_PRICES.socialPosts} per post. Volume discounts apply.`}
                </div>
              }
              placement="left"
            >
          ...
          <div className="mt-4 bg-white/60 rounded-lg p-4 border border-pink-100">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-700">
              <div className="flex items-center gap-2">
                ...
                <span><strong>${UNIT_PRICES.socialPosts}</strong> per post ({UNIT_PRICES.socialPosts * 100} cents)</span>
              </div>
              <div className="flex items-center gap-2">
