...
export default function NotesTab() {
  ...
  const handleGetEstimate = async () => {
    ...
    try {
      const response = await billingAPI.getEstimate(location.id, 'notes', {});
      if (response.success) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Export all contact notes from this sub-account</p>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Notes are exported with contact details into a CSV or JSON file</span>
              </li>
              <li className="flex items-start gap-2">
